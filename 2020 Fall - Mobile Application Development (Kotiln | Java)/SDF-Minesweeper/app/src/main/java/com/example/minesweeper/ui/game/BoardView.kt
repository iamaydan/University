...
import com.example.minesweeper.game.moves.ChordMove
import com.example.minesweeper.game.moves.FloodRevealMove
import com.example.minesweeper.game.moves.ToggleFlagMove
import com.example.minesweeper.roundUp
...
class BoardView(
    ...
    private val uncoveredPaint = Paint(basePaint).apply { color = Color.WHITE }
    private val coveredPaint = Paint(basePaint).apply { color = Color.parseColor("#dfe4ea") }
    private val minePaint = Paint(basePaint).apply { color = Color.parseColor("#ffc7cc") }
    private val flagPaint = Paint(basePaint).apply { color = Color.parseColor("#f8a5c2") }
